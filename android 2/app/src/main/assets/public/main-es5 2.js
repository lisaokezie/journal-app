...
var routes = [
    { path: '', loadChildren: function () { return Promise.all(/*! import() | tabs-tabs-module */[__webpack_require__.e("default~add-entry-add-entry-module~edit-entry-edit-entry-module~tabs-tabs-module"), __webpack_require__.e("common"), __webpack_require__.e("tabs-tabs-module")]).then(__webpack_require__.bind(null, /*! ./tabs/tabs.module */ "./src/app/tabs/tabs.module.ts")).then(function (m) { return m.TabsPageModule; }); } },
    {
        path: 'detail',
    ...
    {
        path: 'add-entry',
        loadChildren: function () { return Promise.all(/*! import() | add-entry-add-entry-module */[__webpack_require__.e("default~add-entry-add-entry-module~edit-entry-edit-entry-module~tabs-tabs-module"), __webpack_require__.e("common")]).then(__webpack_require__.bind(null, /*! ./add-entry/add-entry.module */ "./src/app/add-entry/add-entry.module.ts")).then(function (m) { return m.AddEntryPageModule; }); }
    },
    {
        path: 'favorites',
        loadChildren: function () { return __webpack_require__.e(/*! import() | favorites-favorites-module */ "favorites-favorites-module").then(__webpack_require__.bind(null, /*! ./favorites/favorites.module */ "./src/app/favorites/favorites.module.ts")).then(function (m) { return m.FavoritesPageModule; }); }
    },
    {
        path: 'tags',
...
module.exports = __webpack_require__(/*! /Users/lisa/Desktop/journal-app/src/main.ts */"./src/main.ts");
