...
const routes = [
    { path: '', loadChildren: () => Promise.all(/*! import() | tabs-tabs-module */[__webpack_require__.e("default~add-entry-add-entry-module~tabs-tabs-module"), __webpack_require__.e("tabs-tabs-module")]).then(__webpack_require__.bind(null, /*! ./tabs/tabs.module */ "./src/app/tabs/tabs.module.ts")).then(m => m.TabsPageModule) },
    {
        path: 'detail',
    ...
    {
        path: 'add-entry',
        loadChildren: () => __webpack_require__.e(/*! import() | add-entry-add-entry-module */ "default~add-entry-add-entry-module~tabs-tabs-module").then(__webpack_require__.bind(null, /*! ./add-entry/add-entry.module */ "./src/app/add-entry/add-entry.module.ts")).then(m => m.AddEntryPageModule)
    },
    {
        path: 'favorites',
