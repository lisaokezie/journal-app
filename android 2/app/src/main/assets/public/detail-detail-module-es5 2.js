...
var DetailPage = /** @class */ (function () {
    function DetailPage(route, tagsService, entriesService, navCtrl) {
        this.route = route;
    ...
    DetailPage.prototype.ngOnInit = function () {
        ...
        */
        this.subscription = this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (params) {
            var entryId = params["id"];
            if (_this.entriesService.loaded) {
                _this.entry = _this.entriesService.getEntry(entryId);
            }
            else {
                _this.entriesService.load().then(function () {
                    _this.entry = _this.entriesService.getEntry(entryId);
                });
            }
            _this.heart = _this.entriesService.getStatus(_this.entry);
            _this.entrytags = _this.entry.tags;
        })).subscribe();
    };
    DetailPage.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
    };
    DetailPage.prototype.deleteEntry = function (entry) {
